## 项目简述
【Desktop】前端项目模版，Desktop 端的业务项目可以基于此模版快速搭建。
...
ngiq-frontend-template-desktop
  ...
  │   ├── CODEOWNERS                # 配置 Code Reviewers，合并 PR 时至少有一个人 Approved
  ├── .husky                        # 存放 git hooks
...
## 项目开发规范
参考[项目开发规范](https://mqhfidmks7.feishu.cn/wiki/wikcnXOnOyzoiT09hZ6KJsSwXGS) （PS: 不用参考和业务项目强相关的开发规范）

## 项目发布规范
参考[项目发布规范](https://mqhfidmks7.feishu.cn/wiki/wikcnQDO7YZUo8FR6pXvhzUG1cb)

## [Git 提交规范](https://mqhfidmks7.feishu.cn/wiki/wikcnXOnOyzoiT09hZ6KJsSwXGS#CC2gdauMaoMS6GxO06Hcf3CgnBg)
### Git Commit 类型
| Commit 类型        | 类型描述                                |
|------------------|-------------------------------------|
